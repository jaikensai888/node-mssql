...
class Transaction extends EventEmitter {
  ...
  asyncBegin(isolationLevel, callback) {
...
class Request extends EventEmitter {
  ...
  asyncQuery(sql, params) {
    return this.query(sqlTranslator.execute(sql, params));

  }
  asyncInsert(sql, params) {
    return this.batch(sqlTranslator.insert(sql, params));

  }
  asyncBatch(sql, params) {
    return this.batch(sqlTranslator.execute(sql, params));
  }
